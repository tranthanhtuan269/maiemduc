...
for($i=0;$i<count($index_chuaxuly);$i++)
{
	...
	echo '<td style="padding-left:6px; border-left: 1px solid #c2c2c2; border-collapse:none;" style=\"padding-left:6px;\" width=\"10\" valign=\"top\"><font size=2>'.number_format($index_chuaxuly[$i]['trn_payment_tm'], 0, '.', ',').'</font></td>';
	echo '<td style="padding-left:6px; border-left: 1px solid #c2c2c2; border-collapse:none;" style=\"padding-left:6px;\" width=\"10\" valign=\"top\"><font size=2>'.number_format($index_chuaxuly[$i]['trn_payment_ck'], 0, '.', ',').'</font></td>';
