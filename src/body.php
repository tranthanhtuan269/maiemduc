			...
			<thead>
				...
				<tr height="22">
					<td>
						<table width="40%">
							<tr>
								<td width="50%" bgcolor="#eeedfb">
									<table width="100%">
										<tr >
											
											<td align="left"  nowrap>&nbsp;<b>Ng&#224;y tr&#7843; h&#224;ng</b>&nbsp;</td>
											<td align="right"  nowrap>&nbsp;<b>S&#7889; ti&#7873;n kh&#225;ch c&#242;n n&#7907;</b>&nbsp;</td>
											<td align="right"  nowrap>&nbsp;<b>N&#7907; l&#361;y k&#7871;</b>&nbsp;</td>
										</tr>
										...
										<?php //echo 'AAAAA'.$cust_phone;
											...
											<tr >
												...
												<td align="left"  nowrap>&nbsp;<b><?=$get_cust_debit[$i]['prg_step4_dt2']?></b>&nbsp;</td>
												<td align="right"  nowrap>&nbsp;<b><?=number_format($get_cust_debit[$i]['trn_payment_remain'], 0, '.', ',')?></b>&nbsp;</td>
												<td align="right"  nowrap>&nbsp;<b><?=number_format($totaldebit, 0, '.', ',')?></b>&nbsp;</td>
											</tr>
											<?php
											}
										?>
										<tr color="yellow">
											<td align="left" colspan=2 height="4"><hr></td>
										</tr>
										<tr color="yellow">
											<td align="left" color="yellow" nowrap>&nbsp;<b><font size="3">T&#7893;ng c&#242;n n&#7907;</b>&nbsp;</font></td>
											<td align="right" color="yellow" nowrap>&nbsp;<b><font size="3"><?=number_format($totaldebit, 0, '.', ',')?></b>&nbsp;</font></td>
										</tr>
									</table>
								</td>
							</tr>
	...
	<thead>		
		<?php if ($_SESSION['step'] == "CARE") { ?>
			<tr bgcolor="#eeedfb" height="22">
				...
				<?php if ($_SESSION['search'] == "user") { ?>
					<td align="left" style="padding-left:6px;" nowrap="nowrap"><b>Ng&#224;y &#273;&#7863;t h&#224;ng</b></td>
				<?php } ?>
				...
				<?php if ($_SESSION['search'] == "user") { ?>
					...
					<td align="left" style="padding-left:6px;" nowrap="nowrap"><b>&#272;&#417;n gi&#225;</b></td>
		...
		<tbody id="body_other">
			<?php
				...
				if (isset($index_chuaxuly)) {
					for($i=0;$i<count($index_chuaxuly);$i++)
					{
						...
						<td align="left" nowrap=\"nowrap\" style=\"padding-left:0px;\"><b><a onclick="if (event.which != 2) makeBlockUI();" href="?search=user&id='.$index_chuaxuly[$i]["trn_cust_phone"].'" class="login-window" id="congtrinh-'.$index_chuaxuly[$i]["cust_id"].'" >'.$index_chuaxuly[$i]["cust_name"].'<!--nguoigoiden--></a></b></td>
						<td align="left" nowrap=\"nowrap\" style=\"padding-left:6px;\">&nbsp;&nbsp;'.$index_chuaxuly[$i]["prd_name"].'<!--tencongtrinh--></a></td>
						';
						if ($_SESSION['search'] == "user") { 
							echo '<td nowrap=\"nowrap\" style=\"padding-left:6px;\">&nbsp;&nbsp;'.$index_chuaxuly[$i]["trn_start_date_f"].'</td>';
						}
						echo '<td nowrap=\"nowrap\" style=\"padding-left:6px;\">&nbsp;&nbsp;'.$prg_step4_dt2.'</td>
						';
						if ($_SESSION['search'] == "user") { 
							echo '<td align="right" nowrap=\"nowrap\" style=\"padding-left:6px;\">&nbsp;&nbsp;<span id="trn_sub_amount_'.$index_chuaxuly[$i]["trn_id"].'">'.$trn_quantity_f.'</span></td>
							<td align="right" nowrap=\"nowrap\" style=\"padding-left:6px;\">&nbsp;&nbsp;<span id="trn_sub_amount_'.$index_chuaxuly[$i]["trn_id"].'">'.$trn_unit_price_f.'</span></td>
							<td align="right" nowrap=\"nowrap\" style=\"padding-left:6px;\">&nbsp;&nbsp;<span id="trn_sub_amount_'.$index_chuaxuly[$i]["trn_id"].'">'.$trn_amount_withoutVAT_f.'</span></td>
							<td align="right" nowrap=\"nowrap\" style=\"padding-left:6px;\">&nbsp;&nbsp;<span id="trn_sub_amount_'.$index_chuaxuly[$i]["trn_id"].'">'.$trn_vat_f.'</span></td>
							';
						}
						...
						<td align="right" nowrap=\"nowrap\" style=\"padding-left:6px;\">&nbsp;&nbsp;'.$payment_all;
						
						echo '</td>
						
						<!--<td align="right" nowrap=\"nowrap\" style=\"padding-left:6px;\">&nbsp;&nbsp;<span id="trn_payment_remain_'.$index_chuaxuly[$i]["trn_id"].'">'.$trn_payment_remain_f.'</span></td>-->
			...
			<tr bgcolor="#eeedfb" height="22">
				...
				<td id="td_trn_start_date" align="left" style="padding-left:6px;" nowrap="nowrap" onclick="submit_sort_col('trn_start_date',$('#imgsrc_trn_start_date').attr('title'));"><b>Ngày k&#253; H&#272;</b> <span id='imgsrc_trn_start_date'></span></td>
				...
				<?php
					...
					for($i=0;$i<count($index_chuaxuly);$i++)
					{
						...
						if ($index_chuaxuly[$i]["prg_status"] > 41)
						{
							...
							{
								$color = "#faf9a8"; // vang
							} else if ($index_chuaxuly[$i]["today_duration"] <= $trans_fixdate_over_max &&
							$index_chuaxuly[$i]["today_duration"] >= $trans_fixdate_over_min
							) 
							{
								$color = "#ff7373"; // do tia
							}
						...
						if (isset($_SESSION['MM_IsSuperAdmin']) && $_SESSION['MM_IsSuperAdmin'] == 1) {
